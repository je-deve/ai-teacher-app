...
# --- تنظيف النصوص الإنجليزية لمنع الانهيار ---
def clean_en(text):
    if not text: return ""
...
def gemini_analyze_audio(path, ref_text, lang="ar"):
    try:
        ...
        if lang == "ar":
            ...
            # English Prompt: Requests one word for badge
            prompt = f"""
